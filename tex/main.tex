...
\makebox[0pt][l]{$\square$}\raisebox{.15ex}{\hspace{0.1em}$\checkmark$} sjekke at den konvergerer (decent ENCUT og KPOINTS)\\
...
\begin{itemize}
    ...
    \subitem done
    \subitem The data shows that we should use 350eV for ENCUT as that is the 1st job with a difference less than 3meV.
