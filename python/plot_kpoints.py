...
plt.title("Convergence of energy by k-points")
plt.xlabel("k-point density [$1/Å^3$]")
...
plt.title("Convergence of energy by k-points - difference")
plt.xlabel("k-point density [$1/Å^3$]")
plt.ylabel("Absolute Total Energy Difference per atom [eV/atom]")
plt.grid()
plt.tight_layout()
plt.savefig("../fig/convergence_kpoints_difference.png")
plt.show()
